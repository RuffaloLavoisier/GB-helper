# Commit: b6f0ea914da0f151c5f6e062cd72f5e3dae481dd
## Message: Garmin: use fit_profile.json to generate FIT message classes - prepare
## Changed files:
app/build.gradle

settings.gradle.kts

FitCodeGenerator/.gitignore
...
## Diff:
```
diff --git a/FitCodeGenerator/.gitignore b/FitCodeGenerator/.gitignore
new file mode 100644
index 0000000000..42afabfd2a
--- /dev/null
+++ b/FitCodeGenerator/.gitignore
@@ -0,0 +1 @@
+/build
\ No newline at end of file
diff --git a/FitCodeGenerator/build.gradle.kts b/FitCodeGenerator/build.gradle.kts
new file mode 100644
index 0000000000..74567d4513
--- /dev/null
...
+}
\ No newline at end of file
diff --git a/app/src/main/java/nodomain/freeyourgadget/gadgetbridge/service/devices/garmin/fit/codegen/FitCodeGen.java b/FitCodeGenerator/src/main/java/nodomain/freeyourgadget/gadgetbridge/service/devices/garmin/fit/codegen/FitCodeGen.java
similarity index 100%
rename from app/src/main/java/nodomain/freeyourgadget/gadgetbridge/service/devices/garmin/fit/codegen/FitCodeGen.java
rename to FitCodeGenerator/src/main/java/nodomain/freeyourgadget/gadgetbridge/service/devices/garmin/fit/codegen/FitCodeGen.java
diff --git a/FitCodeGenerator/src/main/resources/fit_profile.json b/FitCodeGenerator/src/main/resources/fit_profile.json
new file mode 100644
index 0000000000..ecdab31f54
--- /dev/null
...
+        "101": {
+          "num": 101,
+          "name": "goal_notification",
+          "baseType": "ENUM"
+        },
+        "117": {
+          "num": 117,
+          "name": "map_show_details",
+          "baseType": "ENUM"
+        },
+        "134": {
+          "num": 134,
...
+        "144": {
+          "num": 144,
+          "name": "activity_true_up",
+          "baseType": "ENUM"
+        },
+        "148": {
+          "num": 148,
+          "name": "map_show_contour",
+          "baseType": "ENUM"
+        },
+        "164": {
+          "num": 164,
...
+        "3": {
+          "num": 3,
+          "name": "training_load_acute",
+          "baseType": "UINT16"
+        },
+        "4": {
+          "num": 4,
+          "name": "training_load_chronic",
+          "baseType": "UINT16"
+        },
+        "253": {
+          "num": 253,
...
index dbbc221d62..be01fce73c 100644
--- a/app/build.gradle
+++ b/app/build.gradle
@@ -164,8 +164,9 @@ android {
     }
...
index 41f392946f..afeb1dd298 100644
